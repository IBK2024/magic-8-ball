...
## About
This is a python version of the popular magic 8 ball fortune telling tool

# Contribution Guidelines

When contributing to `Magic 8 Ball`, whether on GitHub or in other community spaces:

- Be respectful, civil, and open-minded.
- Before opening a new pull request, try searching through the [issue tracker](https://github.com/IBK2024/magic-8-ball/issues) for known issues or fixes.
...
In order to not waste your time implementing a change that has already been declined, or is generally not needed, start by [opening an issue](https://github.com/IBK2024/magic-8-ball/issues/new/choose) describing the problem you would like to solve.
